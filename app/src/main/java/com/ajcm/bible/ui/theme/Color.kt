...
import com.ajcm.domain.entity.LocalColors
import com.ajcm.domain.entity.transformToColor
...
@Composable
fun String.toLocalColor(): Color {
    return when(this.transformToColor()) {
        LocalColors.Blue -> MaterialBibleTheme.colors.blue
        LocalColors.BlueLight -> MaterialBibleTheme.colors.blueLight
        LocalColors.Brown -> MaterialBibleTheme.colors.brown
        LocalColors.BrownLight -> MaterialBibleTheme.colors.brownLight
        LocalColors.Orange -> MaterialBibleTheme.colors.orange
        LocalColors.OrangeLight -> MaterialBibleTheme.colors.orangeLight
        LocalColors.Green -> MaterialBibleTheme.colors.green
        LocalColors.Red -> MaterialBibleTheme.colors.red
    }
}
